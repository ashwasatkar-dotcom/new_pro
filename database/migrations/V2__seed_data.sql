-- V2__seed_data.sql
-- Seed Initial Data for HostelHub (Matching Stitch Design)
...
('STU-2024-112', '$2a$10$lKb4wot.KEzR2LSDEVMky.NCh60MHafmTlDbhFBl3yu/cUQruA37.', 'Marcus Chen', 'marcus.chen@campus.edu', '+1 (555) 891-4420', 'ROLE_STUDENT', 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=200&auto=format&fit=crop', 'Electrical Engineering', 'Wing B', 1),
('STU-2024-205', '$2a$10$lKb4wot.KEzR2LSDEVMky.NCh60MHafmTlDbhFBl3yu/cUQruA37.', 'Devon Bailey', 'devon.bailey@campus.edu', '+1 (555) 234-9988', 'ROLE_STUDENT', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&auto=format&fit=crop', 'Mechanical Engineering', 'Wing B', 1),
('STU-2024-340', '$2a$10$lKb4wot.KEzR2LSDEVMky.NCh60MHafmTlDbhFBl3yu/cUQruA37.', 'Liam O''Connor', 'liam.oc@campus.edu', '+1 (555) 772-1092', 'ROLE_STUDENT', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&auto=format&fit=crop', 'Civil Engineering', 'Wing A', 1);
...
VALUES
(1, CAST(GETDATE() AS DATE), 'PRESENT', '21:30', 'Biometric scan verified at North Gate', 1),
(2, CAST(GETDATE() AS DATE), 'PRESENT', '21:45', 'Card swipe East Turnstile', 1),
(3, CAST(GETDATE() AS DATE), 'LATE', '22:15', 'Late return from project lab, signed curfew log', 1),
(4, CAST(GETDATE() AS DATE), 'LEAVE', NULL, 'Weekend home pass approved by Warden', 1);
